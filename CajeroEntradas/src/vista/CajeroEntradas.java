...
//		Va mal
		...
		lblNewLabel_2.setBounds(187, 41, 485, 325);
		seleccionPeliPanel.add(lblNewLabel_2);

		JComboBox spCbDia = new JComboBox();
		...
		spBtnBuscarDia.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				controlador.escogerFecha(horariosCbHorariosDisponibles, spCbSeleccionPeli, spCbDia);
			}
		});
...
//		REGISTRO
		...
		registroBtnAceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				controladorEneko = new ControladorEneko();
				controladorEneko.mostrarPanelInicio(inicioPanel, registroPanel, seleccionCinePanel, seleccionPeliPanel,
...
//		RESUMEN DE COMPRA
		...
		rcBtnAceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				controladorEneko = new ControladorEneko();
				controladorEneko.mostrarPanelLogin(inicioPanel, registroPanel, seleccionCinePanel, seleccionPeliPanel,
						horariosPanel, resumenCompraPanel, loginPanel);
			}
		});
